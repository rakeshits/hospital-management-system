...
const LEADERSHIP = [
  { name: 'Dr. Suresh Menon',  role: 'CEO & Chief Medical Officer',     exp: '30 yrs', init: 'SM', color: 'bg-sky-100 text-sky-800'     },
  ...
  return (
    <PublicLayout>
      ...
      <section className="relative pt-40 pb-24 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-sky-900 via-sky-800 to-blue-800" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 text-center">
          ...
          <h1 className="text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-300 to-teal-300">One Patient at a Time</span>
          </h1>
          ...
          <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            {[
              { val: '25+',    label: 'Years',    color: 'from-sky-500 to-sky-700'      },
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            { icon: Target, color: 'bg-sky-500', title: 'Our Mission',
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-12">
            <span className="text-sky-500 font-bold text-xs uppercase tracking-widest">What We Stand For</span>
            <h2 className="text-4xl font-extrabold text-slate-800 mt-2">Our Core Values</h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {VALUES.map(({ icon: Icon, title, desc }, i) => (
              <div key={title} className={`card p-6 group hover:border-sky-200 border border-transparent animate-fade-in delay-${(i%4)+1}`}>
                <div className="w-11 h-11 bg-sky-50 rounded-xl flex items-center justify-center mb-4 group-hover:bg-sky-100 transition-colors">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-12">
            <span className="text-sky-500 font-bold text-xs uppercase tracking-widest">Our Journey</span>
            <h2 className="text-4xl font-extrabold text-slate-800 mt-2">Milestones That Define Us</h2>
          </div>
          <div className="relative">
            <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-sky-400 to-sky-100" />
            <div className="flex flex-col gap-10">
              {TIMELINE.map(({ year, event }, i) => (
                <div key={year}
                  ...
                  <div className="shrink-0 w-14 h-14 rounded-full bg-sky-500 border-4 border-white shadow-lg flex items-center justify-center z-10 text-white font-extrabold text-xs text-center leading-tight">
                    {year}
                  </div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="text-center mb-12">
            <span className="text-sky-500 font-bold text-xs uppercase tracking-widest">Our Leadership</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {LEADERSHIP.map(({ name, role, exp, init, color }, i) => (
              <div key={name} className={`card text-center overflow-hidden animate-fade-in delay-${i+1}`}>
                <div className="bg-gradient-to-br from-sky-50 to-blue-50 h-28 flex items-center justify-center">
                ...
                <div className="p-5">
                  ...
                  <p className="text-sky-500 text-xs font-semibold mt-1 mb-2">{role}</p>
      ...
      {/* ACCREDITATIONS */}
      <section className="py-16 bg-gradient-to-br from-sky-900 to-blue-900 relative overflow-hidden">
        <div className="absolute inset-0 opacity-10"
          style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, white 1px, transparent 0)', backgroundSize: '36px 36px' }} />
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 text-center">
          <h2 className="text-3xl font-extrabold text-white mb-2">Accreditations & Certifications</h2>
          <p className="text-sky-200 text-sm mb-8">Recognised by the world's most rigorous healthcare quality bodies.</p>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1">
            <span className="text-sky-500 font-bold text-xs uppercase tracking-widest">Find Us</span>
          ...
          <div className="flex-1 w-full h-56 md:h-72 bg-sky-50 rounded-2xl border border-sky-100 flex items-center justify-center text-slate-400">
            <div className="text-center">
              <MapPin className="w-10 h-10 text-sky-300 mx-auto mb-2" />
